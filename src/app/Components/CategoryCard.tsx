    ...
    <>
      {loading ? (
        <div className="block h-72 sm:min-w-[260px] min-w-[220px] force-width relative select-none border border-secondary-0 ">
          <h1 className="absolute bottom-5 h-3 w-3/4 ml-5 rounded-lg font-semibold bg-secondary-0 px-4 text-left z-30 select-none "></h1>
          <h1 className="absolute bottom-12 h-3 w-3/5 ml-5 rounded-lg font-semibold bg-secondary-0 px-4 text-left z-30 select-none "></h1>
